...
(function($,window){
    ...
    DW.music = function(options) {
            ...
            source:                 [
                                        {
                                            ...
                                            singer:'BiSH',
                                            url:'./music/1.mp3',
                                            img_url:'https://gss0.bdstatic.com/94o3dSag_xI4khGkpoWK1HF6hhy/baike/c0%3Dbaike272%2C5%2C5%2C272%2C90/sign=d0ca2b62e524b899ca31716a0f6f76f0/54fbb2fb43166d22b7b814f64a2309f79152d281.jpg',
                                        },{
                                            name:'キミの隣',
                                            singer:'halca',
                                            url:'./music/2.mp3',
                                            img_url:'https://gss3.bdstatic.com/-Po3dSag_xI4khGkpoWK1HF6hhy/baike/c0%3Dbaike150%2C5%2C5%2C150%2C50/sign=c7a7ae4236292df583cea447dd583705/a686c9177f3e67099a742e9237c79f3df8dc5562.jpg',
                                        },{
                                            name:'オラシオン(游戏人生ed)',
                                            singer:'茅野愛衣',
                                            url:'./music/3.mp3',
                                            img_url:'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1529690209&di=33330b768f067e07f7a2e39278323b74&imgtype=jpg&er=1&src=http%3A%2F%2Fimg4.duitang.com%2Fuploads%2Fitem%2F201407%2F13%2F20140713155406_E8XNW.jpeg'
                                        },{
                                            name:'純情エモーショナル ユミナver(带著智慧型手机闯荡异世界)',
                                            singer:'高野麻里佳',
                                            url:'./music/4.mp3',
                                            img_url:'https://gss3.bdstatic.com/-Po3dSag_xI4khGkpoWK1HF6hhy/baike/c0%3Dbaike92%2C5%2C5%2C92%2C30/sign=a8c770e5d858ccbf0fb1bd6878b1d75b/377adab44aed2e7390cd5f7b8e01a18b87d6fa45.jpg'
                                        },{
                                            name:'DAISY(境界的彼方)',
                                            singer:'stereo dive foundation',
                                            url:'./music/5.mp3',
                                            img_url:'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1529095485563&di=90dc5abfccd367e04e85acb0cd9e7386&imgtype=0&src=http%3A%2F%2Fpic35.photophoto.cn%2F20150508%2F0005018303699566_b.jpg'
                                        },{
                                            name:'云烟成雨',
                                            singer:'房东的猫',
                                            url:'./music/6.mp3',
                                            img_url:'https://gss3.bdstatic.com/7Po3dSag_xI4khGkpoWK1HF6hhy/baike/c0%3Dbaike272%2C5%2C5%2C272%2C90/sign=633e61c98c0a19d8df0e8c575293e9ee/cc11728b4710b912677dce86cffdfc039245220d.jpg'
                                        },{
                                            name:'ひだまりデイズ(干物妹小埋)',
                                            singer:'田中あいみ,影山灯,白石晴香',
                                            url:'./music/7.mp3',
                                            img_url:'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1529095603084&di=9b939d55cfbaafa353682d34f3b60f7f&imgtype=0&src=http%3A%2F%2Fimg4.duitang.com%2Fuploads%2Fitem%2F201509%2F03%2F20150903153202_GfivA.png'
                                        }
                                    ],
        ...
        musicValue._init = function(){
            if(opt.isCenter){
                _this.cpt_music = $('<div class="cpt-dw-music music-div active" id="music"></div>').css({
                    width:opt.width,
                    height:opt.height,
                    bottom:opt.bottom,
                    left:opt.left,
            ...
            _this.music_prev = $('<div class="next"><i class="glyphicon glyphicon-fast-backward"></i></div>').appendTo(_this.music_play);
            _this.music_status = $('<div class="pauseplay"><i class="dw-icon-play"></i></div>').appendTo(_this.music_play);
            _this.music_next = $('<div class="next"><i class="glyphicon glyphicon-fast-forward"></i></div>').appendTo(_this.music_play);
            ...
            _this.music_div = document.getElementById('music');
        }
        ...
        musicValue._clickEvent = function(){
            ...
            _this.music_prev.off().on('click',function(event){
                event.stopPropagation();
